...
citynames1.php generates a JavaScript file defining a createCitiesPlugin for Planetary.js, which loads city data from a text file and manual entries, then displays them as interactive markers on a 3D globe. 
